    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl w-full max-w-md">
        ...
        <div className="px-6 py-4">
          <p className="text-gray-700 dark:text-gray-300 font-robotoRegular mb-2">
            ¿Estás seguro de que deseas eliminar este producto?
          </p>
          <div className="p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-lg mt-2">
            <p className="text-red-800 dark:text-red-300 font-robotoMedium">
              {productName}
            </p>
          </div>
          <p className="text-gray-600 dark:text-gray-400 font-robotoRegular text-sm mt-3">
